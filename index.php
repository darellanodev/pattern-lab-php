...
<body class="dark:bg-gray-900 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <h2 class="text-2xl font-semibold text-gray-200 mb-6">Techniques</h2>
            <?php PatternCard::render(
                'Fluent Interface',
                'Chains method calls by having each one return the object itself ($this). Like customizing a character in a game: equip a sword, heal up, level up — all in one flowing action instead of separate steps.',
                'building or configuring objects through readable, chainable method calls.',
